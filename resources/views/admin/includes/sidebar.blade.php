<nav class="bg-dark text-white vh-100 col-2">
    ...
    <div class="mt-3 border-bottom border-white pb-3">
        <div class="container py-1">
            ...
            <span class="ms-3 mt-1">{{ ucfirst(strtolower(\Illuminate\Support\Facades\Auth::user()->first_name)) }} {{ ucfirst(strtolower(\Illuminate\Support\Facades\Auth::user()->name)) }}</span>
        </div>
        @env(['local', 'staging'])
        <div class="container py-1">
